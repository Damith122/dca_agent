...
class LauncherTests(unittest.TestCase):
    def test_exchange_credentials_are_cleared_and_paper_archive_is_isolated(self):
        original = {"DRY_RUN": "false", "LIVE_TRADING_CONFIRMATION": "true",
                    "BINANCE_API_KEY": "DO_NOT_SEND", "BINANCE_API_SECRET": "DO_NOT_SEND",
                    "GITHUB_TOKEN": "ARCHIVE_TOKEN", "GITHUB_REPO": "owner/repo",
                    "GITHUB_BRANCH": "main",
                    "TRADE_LOG_JSON_PATH": "trades_log_LIVE_SOLUSDT.jsonl",
    ...
    def test_paper_launcher_stays_valid_without_github_credentials(self):
