...
### 30d/90d funding-aware TSMOM consensus result

Deployment `bc3aba56-d1a0-4e04-a1ef-1ca77cb7e5d3` ran frozen commit `1891a74e49d3f9c904b172d4ca9e9170c449aafc` and emitted `[tsmom-consensus-summary]`. The development result was technically positive by only **$0.00121** across 9 simulated trades: $15 -> $15.00121, PF 1.0014, CAGR 0.004%, drawdown 3.79%, and estimated monthly PnL approximately $0.00005. Ten-bps-side stress was negative (-$0.02653), the trade sign-flip p-value was 0.511, and two neighbouring confirmation horizons were negative. The three folds were -$0.3279, +$0.1246 and +$0.2861.

Independent 30-day forward diagnostics were encouraging (69 observations, +11.41% fee-net mean, t=2.78), but the executable weekly one-position/minimum-order strategy did not capture that broad forward move: 58 entries were blocked by the $15 sizing/minimum-risk constraint and only 9 trades closed. It failed PF, stress, CAGR and statistical hurdles, so the sealed final 25% remained unopened. The overlay is rejected and does not replace the already admitted base 30-day TSMOM candidate. Live orders sent: **0**. Evidence: `brain/TSMOM_CONSENSUS_20260903_validation_summary.json` on `brain-state`.
